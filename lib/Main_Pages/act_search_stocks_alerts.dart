...
import 'package:optionxi/Controllers/stock_search_controller_alert.dart';

class StockSearchPageAlerts extends StatefulWidget {
  const StockSearchPageAlerts({Key? key}) : super(key: key);

  @override
  _StockSearchPageAlertsState createState() => _StockSearchPageAlertsState();
}

class _StockSearchPageAlertsState extends State<StockSearchPageAlerts> {
  final StockSearchControllerAlert controller =
      Get.put(StockSearchControllerAlert());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stock Alert Search'),
      ),
      body: Padding(
              ...
              : controller.searchResults.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          onTap: () => controller.handleStockSelect(stock),
                          child: Container(
